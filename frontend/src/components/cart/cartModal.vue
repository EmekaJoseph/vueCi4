    ...
    <div class="modal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header fw-bold">ITEMS CART
                                ...
                                <tr v-for="(item, index) in u_val.cart" :key="index">
                                    ...
                                    <td>
                                        <button @click="removeFromCart(item.id)"
                                            class="btn btn-dark btn-sm px-3">Remove</button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <div class="modal-footer">
                    <button v-show="u_val.cart.length" @click="checkOut" class="btn btn-sm btn-primary">Proceed to
                        checkOut!</button>
